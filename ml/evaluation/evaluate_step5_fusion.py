...
<head>
    ...
    <title>AI-IDR — Intelligent Dead Reckoning | SIH26168</title>
    <style>
        :root {{
            --bg-color: #0f172a;
            --panel-bg: #1e293b;
...
<body>
    <div class="container">
        <div id="errorBanner" class="error-banner">
            ⚠️ Unable to load evaluation sequence dataset or sensor telemetry unavailable.
        </div>
        ...
        <div class="header">
            <div class="header-title">
                ...
                <p>Adaptive GNSS + INS + AI Sensor Fusion | SIH26168 Interactive Benchmark</p>
            </div>
            <div>
        ...
        <div class="step-bar">
            <div class="step-title">📋 SIH26168 Demonstration Workflow Steps</div>
            <div class="step-grid">
        ...
        <div class="user-input-box">
            <div class="user-input-title">🎛️ DYNAMIC USER INPUTS & BENCHMARK PARAMETERS</div>
            <div class="user-input-grid">
                ...
                <div class="input-group">
                    <label for="user-target-threshold">SIH Target Drift Threshold (%)</label>
        ...
        <div class="main-layout">
            ...
            <div class="controls-panel">
                ...
                <button class="btn btn-success" id="btnRestoreGNSS" onclick="restoreGNSS()">🛰️ Restore GNSS</button>
        ...
        <div class="bottom-grid">
            ...
            <div class="sih-card">
                <div class="sih-title">
                    <span>🏆 DYNAMIC SIH26168 BENCHMARK RESULT</span>
            ...
            <div class="debug-panel">
                <div class="debug-title">🛠️ DEBUG METRICS TELEMETRY PANEL</div>
                <div class="debug-grid">
                    ...
                    <div class="debug-item">
                        <div class="debug-label">SIH Target Status</div>
        ...
        function updateBenchmark() {{
            ...
            if (passed) {{
                explanationStr = "✅ <b>BENCHMARK RESULT: PASS</b><br>" +
                    ...
                    "This performance satisfies the user-defined SIH target threshold of <b>< " + targetThresholdPct.toFixed(1) + "%</b> → <b>PASS</b>.";
            }} else {{
                explanationStr = "❌ <b>BENCHMARK RESULT: FAIL</b><br>" +
                    "Evaluated sequence <b>" + activeSeqKey + "</b> over a <b>" + outageDurSec.toFixed(1) + "s</b> outage under <b>" + (evalMode === 'kinematic' ? "Kinematic GT Basis" : "Raw GPS Basis") + "</b>.<br>" +
                    "Calculated position drift is <b>" + calculatedDriftPct.toFixed(2) + "%</b> (" + calculatedDriftM.toFixed(2) + "m drift over " + refDist.toFixed(1) + "m reference distance).<br>" +
                    "This exceeds the user-defined SIH target threshold of <b>< " + targetThresholdPct.toFixed(1) + "%</b> → <b>FAIL</b>.<br>" +
